...
class MESH_OT_info_volume(Operator):
    ...
    def execute(self, context):
        from .. import lib
        from ..report import update  # Importa o report somente quando necessário
        ...
        update((tip_("Volume: {}³").format(volume_fmt), None))  # Chama o report
...
class MESH_OT_info_area(Operator):
    ...
    def execute(self, context):
        ...
        update((tip_("Area: {}²").format(area_fmt), None))  # Chama o report
...
class MESH_OT_report_select(Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            # Possíveis arrays estão fora de sincronia
...
class WM_OT_report_clear(Operator):
    ...
    def execute(self, context):
        from ..report import clear  # Importa o report somente quando necessário
        clear()  # Chama a função para limpar o relatório
